...
\begin{frame}{About me}
  ...
  \begin{varwidth}{8cm}
    \begin{itemize}
    \item \texttt{niccolo.nicolosi@polimi.it}
    \item PhD candidate at Politecnico di Milano
    \item I work on compiler research
  \end{itemize}
  \end{varwidth}
  \end{center}
  \vspace{\stretch{3}}
